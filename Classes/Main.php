...
class Main
{
     ...
     *
     */
    public function user_isMobileForced($browserId = null)
    {
        $forced = ($this->isMobileForced() || $this->isMobile());

        if ($forced && !empty($browserId)) {
            if (strpos($browserId, $this->getDetectedMobileBrowser()) !== false) {
                return true;
            } else {
                return false;
            }
     ...
     *
     */
    public function user_isStandardForced()
    {
        return $this->isStandardForced();
    }
     ...
     *
     */
    public function user_isMobile($browserId = null)
    {
        if (!empty($browserId)) {
            if (strpos($browserId, $this->getDetectedMobileBrowser()) !== false) {
                return true;
